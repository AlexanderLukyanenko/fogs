...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/utils.js */ "./node_modules/@websanova/vue-auth/src/lib/utils.js");
/* harmony import */ var _lib_token_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/token.js */ "./node_modules/@websanova/vue-auth/src/lib/token.js");
/* harmony import */ var _lib_cookie_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/cookie.js */ "./node_modules/@websanova/vue-auth/src/lib/cookie.js");
...
function _isAccess(role, key) {
    if (__auth.$vm.authenticated === true) {
        if (role) {
            return _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["compare"](role, (__auth.$vm.data || {})[key || __auth.options.rolesKey]);
        }
...
function _isTokenExpired() {
    return ! _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["get"].call(__auth);
}
...
function _getRemember() {
    return _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["get"].call(__auth, __auth.options.rememberKey);
}
...
function _setStaySignedIn(staySignedIn) {
    if (staySignedIn === true) {
        _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["set"].call(__auth, __auth.options.staySignedInKey, 'true', false);
    }
    else {
        _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["remove"].call(__auth, __auth.options.staySignedInKey);
    }
}

function _setRemember(val) {
    if (val) {
        _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["set"].call(__auth, __auth.options.rememberKey, val, false);
        __auth.$vm.remember = val;
    }
    else {
        _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["remove"].call(__auth, __auth.options.rememberKey);
...
function _parseRequestIntercept(req) {
    ...
    token = _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["get"].call(__auth, tokenName);
...
function _parseResponseIntercept(res, req) {
    ...
    if (token) {
        _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["set"].call(this, null, token, (_lib_token_js__WEBPACK_IMPORTED_MODULE_1__["get"].call(__auth, __auth.options.staySignedInKey) ? false : true));
    }
}
...
function _processAuthenticated(cb) {
    if (
        ...
        _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["get"].call(__auth)
    ) {
...
function _processTransitionEach(transition, routeAuth, cb) {
    ...
    routeAuth = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["toArray"]((routeAuth || '').roles !== undefined ? routeAuth.roles : routeAuth);

    if (routeAuth && (routeAuth === true || routeAuth.constructor === Array || _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["isObject"](routeAuth))) {
        if ( ! __auth.check()) {
        ...
        else if ((routeAuth.constructor === Array || _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["isObject"](routeAuth)) && ! _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["compare"](routeAuth, __auth.$vm.data[__auth.options.rolesKey])) {
...
function _processLogout(redirect) {
    _lib_cookie_js__WEBPACK_IMPORTED_MODULE_2__["remove"].call(__auth, __auth.options.tokenImpersonateKey);
    _lib_cookie_js__WEBPACK_IMPORTED_MODULE_2__["remove"].call(__auth, __auth.options.tokenDefaultKey);

    _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["remove"].call(__auth, __auth.options.tokenImpersonateKey);
    _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["remove"].call(__auth, __auth.options.tokenDefaultKey);
...
function _processImpersonate(defaultToken, redirect) {
    _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["set"].call(__auth, __auth.options.tokenImpersonateKey, __auth.token(), _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["get"].call(__auth, __auth.options.staySignedInKey) ? false : true);
    _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["set"].call(__auth, __auth.options.tokenDefaultKey, defaultToken, _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["get"].call(__auth, __auth.options.staySignedInKey) ? false : true);
...
function Auth(Vue, options) {
    ...
    this.options = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__defaultOptions, options);
...
Auth.prototype.impersonating = function () {
    var impersonating = _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["get"].call(__auth, __auth.options.tokenImpersonateKey) ? true : false;
...
Auth.prototype.token = function (name, token, expires) {
    if (token !== undefined) {
        if (token === null) {
            _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["remove"].call(__auth, name);
        }
        else {
            expires = (expires === true || expires === false) ? expires : (_lib_token_js__WEBPACK_IMPORTED_MODULE_1__["get"].call(__auth, __auth.options.staySignedInKey) ? false : true);

            _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["set"].call(__auth, name, token, expires);
        }
    }

    return _lib_token_js__WEBPACK_IMPORTED_MODULE_1__["get"].call(__auth, name);
};

Auth.prototype.fetch = function (data) {
    data = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__auth.options.fetchData, data);
...
Auth.prototype.refresh = function (data) {
    data = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__auth.options.refreshData, data);

    return __auth.http.http.call(__auth, data);
};

Auth.prototype.register = function (data) {
    var registerData = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__auth.options.registerData, data);
        ...
        __auth.http.http
            ...
            .then((res) => {
                ...
                if (registerData.autoLogin) {
                    loginData = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__auth.options.loginData, data);
...
Auth.prototype.login = function (data) {
    data = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__auth.options.loginData, data);
...
Auth.prototype.logout = function (data) {
    data = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__auth.options.logoutData, data);
...
Auth.prototype.impersonate = function (data) {
    data = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__auth.options.impersonateData, data);
...
Auth.prototype.unimpersonate = function (data) {
    data = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__auth.options.unimpersonateData, data);
...
Auth.prototype.oauth2 = function (type, data) {
    ...
    if (data.code) {
        ...
        data = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__auth.options.oauth2Data, [data.state, data]);
    ...
    data = _lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["extend"](__auth.options.oauth2[type], data);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _auth_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./auth.js */ "./node_modules/@websanova/vue-auth/src/auth.js");


function plugin(Vue, options) {
    Vue.auth = new _auth_js__WEBPACK_IMPORTED_MODULE_0__["default"](Vue, options);
...
/***/ "./node_modules/@websanova/vue-auth/src/lib/storage.js":
/*!*************************************************************!*\
  !*** ./node_modules/@websanova/vue-auth/src/lib/storage.js ***!
  \*************************************************************/
/*! exports provided: get, set, remove */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "set", function() { return set; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "remove", function() { return remove; });
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.js */ "./node_modules/@websanova/vue-auth/src/lib/utils.js");
/* harmony import */ var _cookie_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cookie.js */ "./node_modules/@websanova/vue-auth/src/lib/cookie.js");
/* harmony import */ var _storage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./storage.js */ "./node_modules/@websanova/vue-auth/src/lib/storage.js");
...
function processToken(action, key, token, expires) {
    ...
    for (; i < ii; i++) {
        if (
            ts[i] === 'storage' &&
            _utils_js__WEBPACK_IMPORTED_MODULE_0__["isLocalStorage"]() &&
            _utils_js__WEBPACK_IMPORTED_MODULE_0__["isSessionStorage"]()
        ) {
            return _storage_js__WEBPACK_IMPORTED_MODULE_2__[action].apply(this, args);
        }

        if (
            ts[i] === 'cookie' &&
            _utils_js__WEBPACK_IMPORTED_MODULE_0__["isCookieStorage"]()
        ) {
            return _cookie_js__WEBPACK_IMPORTED_MODULE_1__[action].apply(this, args);
        }
    }
}
...
/*!***********************************************************!*\
  !*** ./node_modules/@websanova/vue-auth/src/lib/utils.js ***!
  \***********************************************************/
/*! exports provided: extend, compare, toArray, isObject, isLocalStorage, isCookieStorage, isSessionStorage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isLocalStorage", function() { return isLocalStorage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isCookieStorage", function() { return isCookieStorage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isSessionStorage", function() { return isSessionStorage; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Layouts_Head__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Layouts/Head */ "./resources/js/components/Layouts/Head.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "App",
  components: {
    Head: _Layouts_Head__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  computed: Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])(['msg', 'msgStatus']),
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])(['popUp'])), {}, {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Layouts/Head.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Layouts/Head.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Layouts/NotFound.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Layouts/NotFound.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/News/News.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/News/News.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetch: function fetch() {
      ...
      this.$http.get('/api/news?page=' + page).then(function (response) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/News/ShowNews.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/News/ShowNews.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])(['popUp'])), {}, {
    ...
    fetch: function fetch() {
      ...
      this.$http.get('/api/users/' + this.$auth.user().id).then(function (response) {
        _this.name = response.data.user.name;
        _this.family = response.data.user.family;
        _this.second = response.data.user.second;
        _this.birthday = response.data.user.birthday;
        _this.img = response.data.user.img;
    ...
    upd: function upd() {
      ...
      this.$http.post('/api/users/' + this.$auth.user().id, formData, config).then(function (response) {
        _this2.popUp({
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/News/News.vue?vue&type=style&index=0&id=35f94b54&scoped=true&lang=css&":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/News/News.vue?vue&type=style&index=0&id=35f94b54&scoped=true&lang=css& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.card__left[data-v-35f94b54]{\n    float: left;\n    width: 300px;\n    height: 225px;\n}\n.pagination-box[data-v-35f94b54]{\n    display: flex;\n    justify-content: center;\n}\n", ""]);
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/News/News.vue?vue&type=style&index=0&id=35f94b54&scoped=true&lang=css&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/News/News.vue?vue&type=style&index=0&id=35f94b54&scoped=true&lang=css& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../../node_modules/css-loader??ref--6-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--6-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./News.vue?vue&type=style&index=0&id=35f94b54&scoped=true&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/News/News.vue?vue&type=style&index=0&id=35f94b54&scoped=true&lang=css&");
      ...
      _c("div", { staticClass: "card-body" }, [
        _vm.has_error
          ? _c("div", { staticClass: "alert alert-danger" }, [
              _c("p", [_vm._v("Неверно указаны данные")])
            ])
          : _vm._e(),
        _vm._v(" "),
        _c(
            ...
            _c(
              ...
              [
                _c("vue-recaptcha", {
                  ref: "recaptcha",
                  attrs: {
                    sitekey: "6LcQMfoUAAAAAN0vXXFg6aQG8xkbDP3OZE5cg0ot",
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Layouts/Head.vue?vue&type=template&id=7fd576b1&scoped=true&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Layouts/Head.vue?vue&type=template&id=7fd576b1&scoped=true& ***!
  \***************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Layouts/NotFound.vue?vue&type=template&id=14666580&scoped=true&":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Layouts/NotFound.vue?vue&type=template&id=14666580&scoped=true& ***!
  \*******************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/News/News.vue?vue&type=template&id=35f94b54&scoped=true&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/News/News.vue?vue&type=template&id=35f94b54&scoped=true& ***!
  \************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        return _c("div", { key: item.id, staticClass: "col-12" }, [
          _c("div", { staticClass: "card m-2" }, [
            _c("div", { staticClass: "card-body d-flex align-items-center" }, [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "card__right ml-2" }, [
                _c("h5", { staticClass: "card-title card__item" }, [
                  _vm._v(_vm._s(item.title))
                ]),
                _vm._v(" "),
                _c("p", { staticClass: "card-text card__item" }, [
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/News/ShowNews.vue?vue&type=template&id=6fed3e1e&scoped=true&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/News/ShowNews.vue?vue&type=template&id=6fed3e1e&scoped=true& ***!
  \****************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "offset-2 col-lg-8" }, [
        ...
        _c("div", { staticClass: "card-body" }, [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "form-group" }, [
                _c("label", { attrs: { for: "family" } }, [_vm._v("Фамилия")]),
                _vm._v(" "),
                _c("input", {
                  directives: [
                    {
                  ...
                  staticClass: "form-control",
                  attrs: { type: "text", id: "family", placeholder: "Фамилия" },
              ...
              _vm._v(" "),
              _c("div", { staticClass: "form-group" }, [
                _c("label", { attrs: { for: "second" } }, [_vm._v("Отчество")]),
                _vm._v(" "),
                _c("input", {
                  directives: [
                    {
              ...
              _vm.img !== null
                ? _c("div", { staticClass: "form-group" }, [
                    ...
                    _c("div", [
                      _c("img", {
                        staticStyle: { width: "240px", height: "320px" },
              ...
              _vm._v(" "),
              _c("div", { staticClass: "form-group" }, [
                _c("label", { attrs: { for: "img" } }, [_vm._v("Фото")]),
                _vm._v(" "),
                _c("input", {
...
/* harmony import */ var _websanova_vue_auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @websanova/vue-auth */ "./node_modules/@websanova/vue-auth/src/index.js");
...
/* harmony import */ var _plugins_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./plugins/router */ "./resources/js/plugins/router.js");
/* harmony import */ var _store_index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./store/index */ "./resources/js/store/index.js");
/* harmony import */ var _plugins_auth__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./plugins/auth */ "./resources/js/plugins/auth.js");
...
vue__WEBPACK_IMPORTED_MODULE_1___default.a.router = _plugins_router__WEBPACK_IMPORTED_MODULE_6__["default"];
...
vue__WEBPACK_IMPORTED_MODULE_1___default.a.use(_websanova_vue_auth__WEBPACK_IMPORTED_MODULE_2__["default"], _plugins_auth__WEBPACK_IMPORTED_MODULE_8__["default"]);
vue__WEBPACK_IMPORTED_MODULE_1___default.a.component('app', _components_App__WEBPACK_IMPORTED_MODULE_5__["default"]); // Vue.component(pagination);

var app = new vue__WEBPACK_IMPORTED_MODULE_1___default.a({
  store: _store_index__WEBPACK_IMPORTED_MODULE_7__["default"],
  router: _plugins_router__WEBPACK_IMPORTED_MODULE_6__["default"],
  el: '#app'
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Head_vue_vue_type_template_id_7fd576b1_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Head.vue?vue&type=template&id=7fd576b1&scoped=true& */ "./resources/js/components/Layouts/Head.vue?vue&type=template&id=7fd576b1&scoped=true&");
/* harmony import */ var _Head_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Head.vue?vue&type=script&lang=js& */ "./resources/js/components/Layouts/Head.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Head_vue_vue_type_template_id_7fd576b1_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Head_vue_vue_type_template_id_7fd576b1_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _ShowNews_vue_vue_type_template_id_6fed3e1e_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ShowNews_vue_vue_type_template_id_6fed3e1e_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "6fed3e1e",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/News/ShowNews.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/News/ShowNews.vue?vue&type=script&lang=js&":
/*!****************************************************************************!*\
  !*** ./resources/js/components/News/ShowNews.vue?vue&type=script&lang=js& ***!
  \****************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ShowNews_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./ShowNews.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/News/ShowNews.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ShowNews_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/News/ShowNews.vue?vue&type=template&id=6fed3e1e&scoped=true&":
/*!**********************************************************************************************!*\
  !*** ./resources/js/components/News/ShowNews.vue?vue&type=template&id=6fed3e1e&scoped=true& ***!
  \**********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ShowNews_vue_vue_type_template_id_6fed3e1e_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./ShowNews.vue?vue&type=template&id=6fed3e1e&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/News/ShowNews.vue?vue&type=template&id=6fed3e1e&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ShowNews_vue_vue_type_template_id_6fed3e1e_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ShowNews_vue_vue_type_template_id_6fed3e1e_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/* harmony import */ var _components_News_News__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/News/News */ "./resources/js/components/News/News.vue");
/* harmony import */ var _components_News_ShowNews__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/News/ShowNews */ "./resources/js/components/News/ShowNews.vue");
...
/* harmony import */ var _components_Layouts_NotFound__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/Layouts/NotFound */ "./resources/js/components/Layouts/NotFound.vue");
...
var routes = [{
  ...
  path: '/news',
  name: 'news',
  component: _components_News_News__WEBPACK_IMPORTED_MODULE_2__["default"]
}, {
  path: '/news/:id',
  name: 'showNews',
  component: _components_News_ShowNews__WEBPACK_IMPORTED_MODULE_3__["default"]
}, {
  path: '/profile',
  name: 'profile',
  ...
  path: '/404',
  name: '404',
  component: _components_Layouts_NotFound__WEBPACK_IMPORTED_MODULE_6__["default"]
}, {
  path: '*',
  redirect: '/404'
}];
...
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.esm.js");
/* harmony import */ var _modules_popUp__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/popUp */ "./resources/js/store/modules/popUp.js");
...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  modules: {
    popUp: _modules_popUp__WEBPACK_IMPORTED_MODULE_2__["default"]
  }
}));

/***/ }),

/***/ "./resources/js/store/modules/popUp.js":
/*!*********************************************!*\
  !*** ./resources/js/store/modules/popUp.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  getters: {
    ...
    msgStatus: function msgStatus(state) {
      return state.msgStatus;
    }
  },
  mutations: {
    popUp: function popUp(state, payload) {
      state.msg = payload.msg;
      state.msgStatus = payload.msgStatus;
    }
  },
  actions: {
    popUp: function popUp(_ref, payload) {
...
__webpack_require__(/*! C:\Server\data\htdocs\fogstream\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Server\data\htdocs\fogstream\resources\sass\app.scss */"./resources/sass/app.scss");
